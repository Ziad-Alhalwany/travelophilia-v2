<div dir="rtl">
# Product Requirements — Travelophilia (MVP)
...
تحويل تجربة السفر من “رسائل وأسعار مبعثرة” إلى رحلة واضحة:
اختيار → تفاصيل → طلب → متابعة CRM → دفع/تأكيد → برنامج رحلة.

---

## 2) MVP نطاق أول إصدار

### صفحات أساسية

- Home
- Destinations
- Choose Your Trip (Templates)
- Trip Details
- Customize Your Trip (Custom Trip Request)
- CRM Leads (داخلي)
- After Submit (تأكيد طلب)

### Features أساسية

- إرسال Custom Trip Request إلى backend
- تسجيل Leads/Requests في DB (Postgres)
- CRM Pipeline بسيط + status updates
- رسائل واتساب (Templates) للمساعدة في التحويل

---

## 3) Non-Goals (ليس الآن)

- Auth كامل + Roles متقدمة
- Payments Integration كامل (مرحلة لاحقة)
- Admin Dashboard كبير

---

## 4) Success Metrics

- Conversion: Visit → Request
